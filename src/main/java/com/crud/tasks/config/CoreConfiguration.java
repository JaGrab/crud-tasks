...
//                .apis(RequestHandlerSelectors.any())
    ...
    @Override
    public void addFormatters(FormatterRegistry formatter) {
    }
    @Override
    ...
    @Override
    public void addReturnValueHandlers(List<HandlerMethodReturnValueHandler> handlerList) {
    }
    @Override
    ...
    @Override
    public void configureHandlerExceptionResolvers(List<HandlerExceptionResolver> resolverList) {
    }
    @Override
    public void extendHandlerExceptionResolvers(List<HandlerExceptionResolver> resolverList) {
    }
    @Override
